...
class PromotionModel {
    ...
    async getOne(promotion_id) {
        try {
            ...
            console.log(err, `-----> err  in getOne function   at promotion_model.js`)
            // console.log(err.message, '-----> err.message')                                                                   
            throw new Api500Error('delete extratimetable', `${err.message}`)
        }
    }
    ...
    async getAll(equipmentprovider_id) {
        try {
            ...
            console.log(err, `-----> err  in getAll function   at promotion_model.js`)
            // console.log(err.message, '-----> err.message')                                                                   
            throw new Api500Error('delete promotion of equipment', `${err.message}`)
        }
    }
}
