   ...
   async createNewEquipmentProvider (provider_id, equipment_id, quantity, availabilitydate, cancellationdate, discountnonrefundable) {
    try {
            ...
            const new_equipmentprovider = await db.query(`INSERT INTO equipmentsproviders(
                provider_id, equipment_id, quantity, availabilitydate, cancellationdate, discountnonrefundable, ctime)
    ...
    async updateOneEquipmentProvider (equipmentprovider_id, provider_id, equipment_id, quantity, availabilitydate, cancellationdate, discountnonrefundable) {
        try {
            console.log(provider_id, equipment_id) 
            const updated_equipmentprovider = await db.query(`UPDATE equipmentsproviders
                SET  provider_id = $1, equipment_id=$2, quantity=$3, availabilitydate=$4, cancellationdate=$5, discountnonrefundable=$6
                WHERE id = $7
                RETURNING *;`, [provider_id, equipment_id, quantity, availabilitydate, cancellationdate, discountnonrefundable, equipmentprovider_id])
